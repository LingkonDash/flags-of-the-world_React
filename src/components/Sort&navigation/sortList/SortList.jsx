...
const SortList = ({handleSort, curSort, ulStyle}) => {
  return (
    <ul className={`${ulStyle} rounded-lg border-4 border-[#3075f469] z-10 bg-base-200 py-6 absolute top-12 shadow-md -right-[100px] -left-7 transition-transform duration-300 flex flex-col justify-center items-start pl-5 gap-5 text-blue-600 font-normal text-xl`}>
